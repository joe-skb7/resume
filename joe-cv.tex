...
activity. Has prior experience with cross-platform applications development in
C++/Qt, algorithms and electronics. Active open-source community member, mentor,
speaker.
...
\bibitem{e} \color{web} \url{https://gitlabdenx.de/u-boot/u-boot/-/commits/master?search=protsenko}
